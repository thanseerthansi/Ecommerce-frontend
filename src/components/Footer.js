...
export default function Footer() {
  ...
  const Getcontact = ()=>{axios.get("http://127.0.0.1:8000/product/contact/").then(response=>{
    // console.log("conactresponse",response.data)
    ...
    <div className="container">
      <div className="footer-widget-wrapper">
        <div className="row justify-content-between">
          <div className="col-xl-4 col-lg-2 col-md-6 col-12 footer-widget">
            <div className="footer-widget-inner">
              ...
              <ul className="footer-menu list-unstyled mb-0 d-md-block">
                {contact ?<>
                  ...
                  <li className="footer-menu-item"><p style={{color:"#FEFEFE",opacity: "0.7"}}>{contact[0].address}</p></li>
                  <li className="footer-menu-item"><p style={{color:"#FEFEFE",opacity: "0.7"}}><Icon icon="akar-icons:facebook-fill" /><span>&nbsp;&nbsp;{contact[0].facebook}</span> </p></li>
                  <li className="footer-menu-item"><p style={{color:"#FEFEFE",opacity: "0.7"}}><Icon icon="ic:baseline-email" /><span>&nbsp;&nbsp;{contact[0].email}</span> </p></li>
                  <li className="footer-menu-item"><p style={{color:"#FEFEFE",opacity: "0.7"}}><Icon icon="akar-icons:instagram-fill" /><span>&nbsp;&nbsp;{contact[0].instagram}</span> </p></li>
                  <li className="footer-menu-item"><p style={{color:"#FEFEFE",opacity: "0.7"}}><Icon icon="akar-icons:whatsapp-fill" /><span>&nbsp;&nbsp;{contact[0].whatsapp}</span> </p></li>
          ...
          <div className="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
            <div className="footer-widget-inner">
              ...
              <ul className="footer-menu list-unstyled mb-0 d-md-block">
                <li className="footer-menu-item"><p style={{color:"#FEFEFE",opacity: "0.7"}}>About us</p></li>
                <li className="footer-menu-item"><p style={{color:"#FEFEFE",opacity: "0.7"}}>Un-Claimable Products</p></li>
                <li className="footer-menu-item"><p style={{color:"#FEFEFE",opacity: "0.7"}}>Why Us?</p></li>
          ...
          <div className="col-xl-4 col-lg-5 col-md-6 col-12 footer-widget">
            <div className="footer-widget-inner">
              ...
              <span style={{color:"#FEFEFE"}}>Subscribe</span>
              ...
              <div className="footer-newsletter">
                ...
                <div className="newsletter-wrapper">
                  <form action="/" className="footer-newsletter-form d-flex align-items-center">
                    ...
                    <button className="footer-newsletter-btn newsletter-btn-white" type="submit">Subscribe</button>
                  </form>
                </div>
                    ...
                    <li className="footer-social-item">
                      <a href="/">
                        <svg className="icon icon-tiktok" width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path fillRule="evenodd" clipRule="evenodd" d="M13.2367 1C13.5336 3.55445 14.9591 5.0774 17.4375 5.23942V8.11251C16.0012 8.25292 14.7431 7.78307 13.2799 6.89739V12.2709C13.2799 19.0972 5.8393 21.2304 2.84795 16.3375C0.925716 13.189 2.10282 7.66426 8.26909 7.44284V10.4725C7.79933 10.5481 7.29717 10.667 6.83821 10.8236C5.46673 11.288 4.68919 12.1575 4.90518 13.6913C5.32094 16.6292 10.7097 17.4986 10.2615 11.7579V1.0054H13.2367V1Z" fill="#FEFEFE" />
                        </svg>
                      </a>
                    </li>
                    <li className="footer-social-item">
